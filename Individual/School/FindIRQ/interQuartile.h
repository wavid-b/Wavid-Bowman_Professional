/*
    ...
    I used fastptr and slowptr in "find median" helper function, then implimented that with linked list splitting to find the IQR
    Put the linked list back together to avoid causing a memory leak.
    ...
    Sample Output:
        3.00 
*/
//not my code, part of the assignment 
#include <iostream>
#include <iomanip>
...
{
    //trash is to fill the inputs required during non-splitting passes
